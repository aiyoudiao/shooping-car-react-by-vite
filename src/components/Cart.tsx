import { App, Button, ButtonProps, ConfigProvider, Empty, InputNumber, List, notification } from 'antd'
import { TinyColor } from '@ctrl/tinycolor'
import { FC, Fragment, RefAttributes } from 'react'
import { ProductDTO } from '../shared/interface'
import { maxInstallmentsSelector, subtotalSelector, totalProductsSelector } from '../redux/selector'
import { ProductInCart, showCart } from '../redux/slice/cartSlice'
import { $query, $exec } from '../redux'
import { clearCart, changeProductAmount, removeProduct } from '../redux/slice/cartSlice'
  ...
  return (
    <div className="flex items-start py-4" data-testid="cart-product">
      ...
      <div className="ml-4 flex-1">
        <h4 className="text-lg text-gray-800 font-bold mb-1 line-clamp-2" title="product.title">
          {product.title}
        </h4>
...
export const SummaryButtom = (
  prpos: JSX.IntrinsicAttributes & ButtonProps & RefAttributes<HTMLButtonElement | HTMLAnchorElement>
) => {
